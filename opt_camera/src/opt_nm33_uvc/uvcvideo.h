// 2009/7/1 Opt Corporation
//   change Private V4L2 control identifiers.
//   add XU_COMMAND definition.
...
#define UVC_GUID_UVC_EXTENSION 	{0x4e, 0x4d, 0x33, 0x30, 0x01, 0x7a, 0xce, 0x41, \
